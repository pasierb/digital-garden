...
const IndexPage = () => (
  <Layout>
    ...
    <p>
      This website is my personal space where I dump my thoughts, mostly about engineering and self improvement.
      Writings that you will find here are sometimes raw, unpolished, even "work in progress".
      This format is inspired by idea of <a href="https://joelhooks.com/digital-garden">digital garden</a>.
    </p>
